...
var ZumElectronAddressBook = function (path, name, pass) {
    if (!(this instanceof ZumElectronAddressBook)) return new ZumElectronAddressBook(pass, name, path);
    this.path = path;
...
ZumElectronAddressBook.prototype.setParams = function (path, pass) {
    if (path) this.path = path;
    if (pass) this.pass = pass;
    return true;
};

ZumElectronAddressBook.prototype.create = function (ignoreExists) {
...
ZumElectronAddressBook.prototype.initFile = function () {
    return new Promise((resolve, reject) => {
        try {
...
ZumElectronAddressBook.prototype.load = function () {
    return new Promise((resolve, reject) => {
...
ZumElectronAddressBook.prototype.save = function (addressBookData) {
    return new Promise((resolve, reject) => {
        let gcm = new GCM(this.pass, this.cipherConfig);
...
module.exports = ZumElectronAddressBook;