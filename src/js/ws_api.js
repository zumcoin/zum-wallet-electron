...
class ZumElectronApi {
    constructor(args) {
        args = args || {};
        if (!(this instanceof ZumElectronApi)) return new ZumElectronApi(args);
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.1) return reject(new Error('Minimum fee is 0.1 ZUM'));
            //[{address: "Zum1xxxx...", amount: 100}];
            var req_params = {
