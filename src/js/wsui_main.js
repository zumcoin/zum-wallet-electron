...
const ZumElectronManager = require('./ws_manager');
const config = require('./ws_config');
const async = require('async');
const AgGrid = require('ag-grid-community');
const wsmanager = new ZumElectronManager();
...
const ZumElectronAddressbook = require('./ws_addressbook');
...
let addressBook = new ZumElectronAddressbook(ADDRESS_BOOK_DEFAULT_PATH);
...
function showInitialPage() {
    ...
    let tsVersionInfo = document.getElementById('zumServiceVersion');
    ...
    function loadAddressBook(params) {
        ...
        if (params) {
            ...
            if (params.name === 'default') {
                addressBook = new ZumElectronAddressbook(ADDRESS_BOOK_DEFAULT_PATH);
            } else {
                addressBook = new ZumElectronAddressbook(params.path, params.name, params.pass);
            }
        }
...
ipcRenderer.on('cleanup', () => {
    ...
    let htmlText = 'Terminating ZumElectron...';
