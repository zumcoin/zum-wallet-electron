...
var SERVICE_CFG = null; // { service_host: '127.0.0.1', service_port: '17070', service_password: 'xxx'};
var SAVE_COUNTER = 0;
var TX_LAST_INDEX = 1;
var TX_LAST_COUNT = 0;
...
function initApi(cfg) {
    if (wsapi instanceof ZumElectronApi) return;
    logDebug('Initializing ZumElectronApi');
    SERVICE_CFG = cfg;
    wsapi = new ZumElectronApi(SERVICE_CFG);
}
...
function checkBlockUpdate() {
    ...
    //let svc = new ZumElectronApi(SERVICE_CFG);
